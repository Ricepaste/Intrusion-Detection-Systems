...
# 2. 資料載入和預處理
traindata = pd.read_csv('dataset/NSL-KDD/KDDTrain+.csv', header=None)
...
encoder_checkpoint_filepath = os.path.join(results_base_dir, "NSLKDD_encoder-checkpoint-{epoch:02d}.pth")
encoder_model_save_path = os.path.join(results_base_dir, "NSLKDD_simsiam_encoder_final.pth")

# 確保結果目錄存在
os.makedirs(results_base_dir, exist_ok=True)

# CSVLogger 記錄 SimSiam loss
csv_log_filepath = os.path.join(results_base_dir, "NSLKDD_simsiam_training_analysis.csv")
